...
AbstractQuickPanel {
    ...
    // Toggles
    readonly property list<string> availableToggleTypes: ["network", "bluetooth", "idleInhibitor", "nightLight", "darkMode", "gameMode", "screenSnip", "colorPicker", "mic", "audio", "notifications", "greyscale"]
