...
MouseArea { // Notification group area
    ...
    Rectangle { // Background of the notification
        ...
        width: parent.width
        color: popup ? Appearance.colors.colOnPrimary : Appearance.colors.colLayer2
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            color: topRow.showAppName ?
                                (popup ? Appearance.colors.colOnSurfaceVariant : Appearance.colors.colSubtext) :
                        ...
                        StyledText {
                            ...
                            color: popup ? Appearance.colors.colOnSurfaceVariant : Appearance.colors.colSubtext
                        }
                    }
